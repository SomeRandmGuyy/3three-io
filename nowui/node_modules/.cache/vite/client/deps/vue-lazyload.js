...
var isPrimitive$1 = Object.freeze({
  __proto__: null,
  "default": isPrimitive,
...
var assignSymbols$1 = Object.freeze({
  __proto__: null,
  ...
  return class Lazy {
    ...
    */
    ...
    _addListenerTarget(el) {
      if (!el) return;
      let target = find(this.TargetQueue, (target2) => target2.el === el);
      if (!target) {
        target = {
          el,
          id: ++this.TargetIndex,
...
var vue_lazyload_esm_default = index;
export {
  Lazy,
  LazyComponent,
  LazyContainerMananger as LazyContainer,
  LazyImage,
  vue_lazyload_esm_default as default
};
