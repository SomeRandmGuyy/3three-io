...
<body class="antialiased">
    ...
    <!-- Include Nuxt.js application script -->
    <div id="__nuxt"></div>
    @php
        $nuxtFiles = glob(public_path('__nuxt/*.js'));
        foreach ($nuxtFiles as $nuxtFile) {
            $fileName = basename($nuxtFile);
            echo "<script src='/__nuxt/{$fileName}'></script>";
        }
    @endphp
    
    <!-- Include Axios script and set CSRF token -->
